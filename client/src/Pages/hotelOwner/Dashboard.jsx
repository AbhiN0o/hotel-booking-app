...
const Dashboard = () => {
  ...
  return (
    <div>
      <Title align={"left"} font={"outfit"} title={"Dashboard"} subtitle={"Monitor your listinggs ,track bookings and analyze revenue-all in one plcae.Stay updated with real time insights to ensure smooth operations."} />
