...
const ListRoom = () => {
  ...
  return (
    <div>
      <Title align={"left"} font={"outfit"} title={"Room Listings"} subtitle={"View,edit or manage all listed rooms. Kepp the information up to date to provide the best experience for the users."}/>
                        ...
                        <tr key={index}>
                            ...
                            <td className='py-3 px-4 text-red-500 border-t border-gray-300 text-sm text-center'>
                                <label className='relative inline-flex items-center cursor-pointer text-gray-900 gap-3'>
                                    <input type='checkbox' className='sr-only peer ' checked={room.isAvailable}></input>
