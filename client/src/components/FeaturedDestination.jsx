...
const FeaturedDestination = () => {
  ...
  return (
    <div className='flex flex-col items-center px-6 md:px-16 lg:px-24 bg-slate-50 py-20'>
      <Title title='Featured Destination'subtitle='Discover our hadnpicked selection of the hotels all around the world, offering unparalleled discounts and luxury!'/>
